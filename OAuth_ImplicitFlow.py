...
def request_tokens(**kwargs):
	...
	if "sessionToken" in response:
		...
		authorizeUrl ="https://" + orgUrl + "/oauth2/" + authServerId + "/v1/authorize?sessionToken="+sessionToken+"&client_id="+clientId+"&scope=" + scopes + "&response_type=" + tokenType + "&response_mode=fragment&nonce=staticNonce&redirect_uri="+redirectUri+"&state=staticState"
